...
pub struct FloatingSizeParser<'a, 'b, 'c>(pub &'a Context<'b, 'c>);

impl Parser for FloatingSizeParser<'_, '_, '_> {
    type Value = (i32, i32);
...
pub struct FloatingPositionParser<'a, 'b, 'c>(pub &'a Context<'b, 'c>);

impl Parser for FloatingPositionParser<'_, '_, '_> {
    type Value = (i32, i32);
