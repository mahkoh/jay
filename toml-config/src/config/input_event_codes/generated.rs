...
pub(super) static KEYCODES: PhfMap<str, MappedKey> = PhfMap {
    ...
    map: &[
        ...
        MappedKey {
            name: "KEY_CAMERA_ACCESS_DISABLE",
            value: 588,
        },
        MappedKey {
        ...
        MappedKey {
            name: "KEY_KBD_LCD_MENU2",
            value: 697,
        },
        MappedKey {
            name: "KEY_EPRIVACY_SCREEN_OFF",
            value: 595,
        },
        MappedKey {
            name: "KEY_KP9",
        ...
        MappedKey {
            name: "KEY_AUTOPILOT_ENGAGE_TOGGLE",
            value: 637,
        },
        MappedKey {
            name: "KEY_F4",
        ...
        MappedKey {
            name: "KEY_MARK_WAYPOINT",
            value: 638,
        },
        MappedKey {
            name: "KEY_FULL_SCREEN",
            value: 372,
        },
        MappedKey {
            name: "KEY_KPMINUS",
        ...
        MappedKey {
            name: "KEY_PRIVACY_SCREEN_TOGGLE",
            value: 633,
        },
        MappedKey {
            name: "BTN_1",
        ...
        MappedKey {
            name: "KEY_PAUSE_RECORD",
            value: 626,
        },
        MappedKey {
            name: "KEY_FISHING_CHART",
            value: 641,
        },
        MappedKey {
            name: "KEY_MACRO15",
