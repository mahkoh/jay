...
Jay creates workspaces on demand. When a normal workspace becomes empty, Jay can
...
control center. The global setting is in the Compositor pane and overrides are
in the Workspaces pane:
...
> [!NOTE]
> This behavior applies to normal workspaces and is evaluated per output.
>
