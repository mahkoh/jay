...
: Dropdown to select what happens to empty normal workspaces when they are left or become inactive
...
Empty Behavior
: Dropdown to select the workspace-specific empty behavior override (normal workspaces only).
