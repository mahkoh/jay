use {
    crate::{
        ...
        backend::{
            ...
            BackendDrmLessee, BackendEotfs, BackendEvent, BackendGammaLutElement, BackendLuminance,
...
impl Connector for MetalConnector {
    ...
    fn gamma_lut_size(&self) -> Option<u32> {
        self.crtc
            .get()
            .and_then(|crtc| crtc.gamma_lut.and_then(|_| crtc.gamma_lut_size))
    }
}
