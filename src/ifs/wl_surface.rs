    ...
    crate::{
        ...
        ifs::{
            ...
            wl_surface::{
                ...
                wp_commit_timer_v1::{CommitTime, WpCommitTimerV1},
                wp_fifo_v1::WpFifoV1,
...
impl BeforeLatchListener for WlSurface {
    fn before_latch(self: Rc<Self>, now: u64, present: u64) -> BeforeLatchResult {
        self.commit_timeline.before_latch(&self, now, present)
    }
}
