...
async fn test(run: Rc<TestRun>) -> TestResult {
    ...
    let buffer = client.create_single_pixel_buffer(crate::theme::Color::from_srgb(0, 255, 0));
    ...
    let invisible_buffer =
        client.create_single_pixel_buffer(crate::theme::Color::from_srgb(255, 255, 0));
