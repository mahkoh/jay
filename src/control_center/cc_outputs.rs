use {
    crate::{
        ...
        egui_adapter::egui_oklch::Color32Ext,
        ifs::{
    ...
    egui_material_icons::icons::{ICON_ADD, ICON_REMOVE},
    egui_tiles::{
...
fn show_enablement(ui: &mut Ui, m: &HeadState, t: &mut Option<HeadState>) -> bool {
    ...
    let diff = v != effective!(m, t).connector_enabled;
    if diff {
        ui.label(match effective!(m, t).connector_enabled {
            true => "enabled",
            false => "disabled",
        });
    }
